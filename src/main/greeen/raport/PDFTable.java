...
public class PDFTable {
    ...
    public static void inBaoCao(String description, File file, float[] width, String date,
     ArrayList<String> name, DefaultTableModel table) throws Exception {
...
//        new ViewerCtrl("deidine.pdf");
    ...
    public static PdfPTable getTable(DefaultTableModel listSalles, ArrayList<String> name, float[] width) 
    throws Exception {
