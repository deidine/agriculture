...
public class PdfSalle {
    ...
    public String readTxtFile(int number) throws Exception {
        String line = null;
...
//        }
    ...
    public static void inBaoCao(File file, String date, String operationType, DefaultTableModel table, String customerInfo, String recu, String back, String total) throws Exception{
        PdfSalle pdf = new PdfSalle();
...
//    assertEquals(expectedText, text.toString());
    ...
    public static PdfPTable getTable(DefaultTableModel listSalles, ArrayList<String> name, String total) throws Exception {
